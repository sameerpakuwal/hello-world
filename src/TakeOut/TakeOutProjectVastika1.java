...
public class TakeOutProjectVastika1 {
	...
	public static void main(String[] args) {
		...
		default:
			System.out.println("Wrong choice! Please enter valid character.");
			System.exit(1);
			return;
		}
		
		System.out.println("Enter the feeds:");
		int feeds = input.nextInt();
		
		int trays = determineTrays(people,feeds);
		
		System.out.println("Enter the price of the tray: ");
